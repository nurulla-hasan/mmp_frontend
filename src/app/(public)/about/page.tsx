...
const features = [
  ...
  },
  {
    ...
    description:
      "এলাকা, সেবা ও রেটিং অনুযায়ী যাচাইকৃত আমিন ও সার্ভেয়ার খুঁজুন এবং Professional Profile দেখুন।",
  },
  {
    icon: MessageSquare,
    title: "Service Request",
    description:
      "জমির কাজের তথ্য দিয়ে Request পোস্ট করুন এবং একাধিক সার্ভেয়ারের কাছ থেকে Quotation গ্রহণ করুন।",
  },
  {
    icon: Save,
    title: "হিসাব সংরক্ষণ",
    description:
      "Calulation project আকারে সংরক্ষণ করুন, পরে edit বা continue করুন। সব হিসাব এক জায়গায় রাখুন।",
  },
  {
    icon: Map,
...
const stats = [
  ...
  { number: "১০০০+", label: "Service Request" },
...
const howItWorks = [
  {
    ...
    title: "প্রয়োজন জানান",
    description:
      "সেবা, জমির অবস্থান ও প্রয়োজনীয় তথ্য দিয়ে request তৈরি করুন।",
  },
  {
    step: "২",
  ...
  },
  {
    ...
    description:
      "অভিজ্ঞতা, verification এবং quotation তুলনা করে সঠিক পেশাজীবী নির্বাচন করুন।",
  },
  {
    step: "৪",
    ...
    <>
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className="rounded-xl border bg-card/80 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/10 hover:ring-2 hover:ring-primary/20 backdrop-blur-sm"
              >
        ...
        <div className="mx-auto mt-10 max-w-3xl space-y-6">
          {[
            ...
            return (
              <div
                key={item.title}
                className="flex items-start gap-4 rounded-lg border bg-card/80 p-5 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md hover:shadow-primary/5 hover:ring-1 hover:ring-primary/20 backdrop-blur-sm"
              >
      ...
      <SectionWrapper padding="lg" bg="primary">
        <div className="relative">
          <div className="pointer-events-none absolute inset-0 mx-auto size-80 rounded-full bg-primary/10 blur-3xl" />
        <SectionHeading
          as="h2"
