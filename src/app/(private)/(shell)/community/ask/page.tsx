          ...
          <Card className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
            <CardContent>
              <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
                ...
                {/* Description */}
                <Field>
                  <FieldLabel htmlFor="description">বিস্তারিত বিবরণ</FieldLabel>
                  <Textarea
                    id="description"
                    rows={6}
                  ...
                  />
                  <p className="mt-1 text-xs text-muted-foreground">
                    যত বিস্তারিত লিখবেন, তত নির্ভুল উত্তর পাবেন। ব্যক্তিগত তথ্য
                    (ফোন, ঠিকানা) পাবলিক পোস্টে শেয়ার করবেন না।
                  </p>
                </Field>
