...
type WhatsAppUpdateProps = {
  user: TAuthUser | null;
};

export function WhatsAppUpdate({ user }: WhatsAppUpdateProps) {
  ...
  return (
    <ModalWrapper
      ...
      title="WhatsApp নম্বর আপডেট করুন"
      description="আপনার WhatsApp নম্বর আপডেট করুন।"
      actionTrigger={
        <Button
          type="button"
          size="icon"
