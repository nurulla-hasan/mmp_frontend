...
export function PricingCards({ compact }: PricingCardsProps) {
  ...
  return (
    <SectionWrapper asSection bg="muted">
          ...
          >
            ...
            <CardContent className="relative flex flex-col">
              ...
              <div
                className={
                  plan.recommended
                    ? "flex size-12 items-center justify-center rounded-xl bg-primary/10 text-primary shadow-sm"
                    : "flex size-12 items-center justify-center rounded-xl bg-muted-foreground/5 text-muted-foreground"
                }
              >
                {index === 0 && (
              ...
              <h3 className="mt-4 text-lg font-semibold font-heading">{plan.name}</h3>
              {!compact && (
              ...
              >
                {plan.recommended ? "এখনই শুরু করুন" : "Plan নির্বাচন করুন"}
              </Button>
            </CardContent>
          </Card>
        ))}
