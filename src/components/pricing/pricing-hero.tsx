    ...
    return (
        <SectionWrapper padding="lg">
            <div className="relative mx-auto max-w-3xl text-center">
                ...
                {/* Heading */}
                <h1 className="mt-6 text-3xl font-bold tracking-tight leading-14 sm:text-4xl lg:text-5xl font-heading">
                ...
                <div className="mt-8 flex flex-wrap justify-center gap-x-6 gap-y-3">
                    {perks.map((perk) => {
                        ...
                        return (
                            <span
                                key={perk.label}
                                className="inline-flex items-center gap-2 rounded-full border bg-card/80 px-4 py-1.5 text-xs font-medium text-foreground shadow-xs "
                            >
