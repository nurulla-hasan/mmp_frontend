        ...
        <div className="flex gap-2">
          ...
          {surveyor.whatsappNumber ? (
            <Button
              ...
              render={
                <a
                  href={`https://wa.me/880${surveyor.whatsappNumber.replace(/^0/, "")}?text=${encodeURIComponent(`হ্যালো, আমি ${surveyor.fullName} এর প্রোফাইল Mouza Map Pro থেকে দেখছি। আপনার সেবা সম্পর্কে জানতে চাই।`)}`}
                  target="_blank"
