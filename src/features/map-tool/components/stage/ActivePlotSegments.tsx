...
import { formatFeetInches, LABEL_OFFSET_DRAWING_SEGMENT, UI_CONFIG } from '@/features/map-tool/utils/canvas';
import { getReadableRotation } from '@/features/map-tool/utils/component-helpers';
import { GROUP_ANGLE_THRESHOLD_DEG } from '@/features/map-tool/utils/geometry';
import { useMapStore } from '@/features/map-tool/store/useMapStore';
import type { PlotSegment, PlotSegmentGroup, ActivePlotLabelData } from '@/features/map-tool/types/stage';
