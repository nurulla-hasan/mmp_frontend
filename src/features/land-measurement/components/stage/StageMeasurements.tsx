...
import { formatFeetInches, LABEL_OFFSET_MEASUREMENT, UI_CONFIG } from '@/features/land-measurement/utils/canvas';
import { isPointInPolygon, clipLineToPolygon } from '@/features/land-measurement/utils/geometry';
