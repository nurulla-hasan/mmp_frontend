    ...
    return (
      <>
        ...
        {onLocateUser && (
          <FloatingToolButton
            icon={LocateFixed}
            label={locating ? "Locating current position…" : "My Current Location (GPS)"}
            active={locating}
            loading={locating}
        ...
        {/* 5. Focus / Zoom to KMZ Button */}
        {onFitKmz && (
          <FloatingToolButton
            icon={Focus}
            label="Zoom to KMZ Map (Focus)"
            onClick={onFitKmz}
            mobile={true}
          />
        )}
